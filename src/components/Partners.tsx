...
const   Partners = () => {
  return (
    <div className='w-full flex flex-col gap-3  px-10  dark:text-white text-black'  >
        ...
        <img src="https://assets-global.website-files.com/61e7d259b7746e2d1df0b68d/656dd9c31bab66563b4b0417_council%20of%20e.svg" loading="lazy" alt="siemens logo" className="max-w-16 md:max-w-32inline-block mx-4 mb-3"></img>
        </div>
