...
const GenerativeAI = () => {
    return (
        ...
        <div className='w-full h-full flex flex-col gap-2 p-2 md:px-40 px-10 bg-monu dark:text-white text-black '>
            ...
            <div className='mt-14 content w-full flex flex-col md:flex-row gap-4 justify-center items-center bg-pink-300 p-4 hover:shadow-2xl  rounded-xl ' >
            ...
            <div className='mt-14 content w-full flex flex-col md:flex-row gap-4 justify-center items-center rounded-xl bg-green-200 p-4' >
                ...
                <img className='w-1/2 h-fit rounded-tr-md rounded-bl-md ' src="../../public/caption.png" alt=" Image Generation " />
