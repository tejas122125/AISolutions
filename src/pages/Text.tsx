...
const Text = () => {
    return (
        <div className='w-full h-full flex flex-col gap-2 md:px-40 px-3 bg-monu dark:text-white text-black '><h1 className='md:text-5xl text-4xl text-center mt-2  md:mt-14 font-bold '> TEXT</h1>
            ...
            <div className=' mt-4 md:mt-14  w-full flex flex-col md:flex-row gap-4 justify-center items-center bg-pink-300 p-4 hover:shadow-2xl  rounded-xl ' >
                <img className=' w-full md:w-1/2 h-64  md:h-96' src="/chatwithpdf.png" alt=" Image Generation " />
          ...
          <a href="/chatwithhpdf">  <button type="button" className="dark:text-white text-black text-base w-fit bg-gradient-to-r ml-4 from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-lg  px-5 py-2.5 text-center me-2 mb-2">Get Started</button></a>
